...
{    
    public static class CandlestickEntity
    {
        ...
        static CandlestickEntity()
        {
            Header = new EntityHeader(Resource.CandlestickBarEntity_CodeName,Resource.CandlestickBarEntity_DisplayName, Resource.CandlestickBarEntity_Description);
