...
namespace Chartoscope.Core.Indicators.UnitTest
{
    ...
    public class SMACrossProbeTest
    {
        ...
        public void SMACrossProbe_PriceBarItemFeedTriggersAnEvent()
        {
            ...
            var feedService = MockObjectFactory.MockManualPriceFeedService();
            var ticker = feedService.Setup(forexPair.Object, timeFrame, PriceBarOption.All);
        ...
        public void SMACrossProbe_CandlestickItemFeedTriggersAnEvent()
        {
            ...
            var feedService = MockObjectFactory.MockManualPriceFeedService();
            var ticker = feedService.Setup(forexPair.Object, timeFrame, CandlestickPriceOption.All);
        ...
        public void SMACrossProbe_CandlestickOptionFeedTriggersAnEvent()
        {
            ...
            var feedService = MockObjectFactory.MockManualPriceFeedService();
            var ticker = feedService.Setup(forexPair.Object, timeFrame, CandlestickPriceOption.Close);
        ...
        public void SMACrossProbe_HeikenAshiItemFeedTriggersAnEvent()
        {
            ...
            var feedService = MockObjectFactory.MockManualPriceFeedService();
            var ticker = feedService.Setup(forexPair.Object, timeFrame, HeikenAshiPriceOption.All);
        ...
        public void SMACrossProbe_HeikenAshiOptionFeedTriggersAnEvent()
        {
            ...
            var feedService = MockObjectFactory.MockManualPriceFeedService();
            var ticker = feedService.Setup(forexPair.Object, timeFrame, HeikenAshiPriceOption.Close);
        ...
        public void SMACrossProbe_RenkoItemFeedTriggersAnEvent()
        {
            ...
            var feedService = MockObjectFactory.MockManualPriceFeedService();
            var ticker = feedService.Setup(forexPair.Object, timeFrame, RenkoPriceOption.All);
        ...
        public void SMACrossProbe_RenkoOptionFeedTriggersAnEvent()
        {
            ...
            var feedService = MockObjectFactory.MockManualPriceFeedService();
            var ticker = feedService.Setup(forexPair.Object, timeFrame, RenkoPriceOption.Low);
